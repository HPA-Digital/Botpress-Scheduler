...
var getNextOccurence = function getNextOccurence(type, exp) {
  switch (type.toLowerCase()) {
    case 'cron':
      ...
      var next1 = _later2.default.schedule(sched1).next(2, (0, _moment2.default)().add(5, 'seconds').toDate())[0];
      return (0, _moment2.default)(new Date(next1));
    case 'natural':
      _later2.default.date.localTime();
      var sched2 = _later2.default.parse.text(exp);
      var next2 = _later2.default.schedule(sched2).next(2, (0, _moment2.default)().add(5, 'seconds').toDate())[1];
