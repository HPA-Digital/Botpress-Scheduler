This is a fork of the [official botpress repository](https://github.com/botpress/botpress) for scheduler.

- Added [fixes proposed by dmk23](https://github.com/botpress/botpress/issues/1106) for scheduler dropping tasks.
